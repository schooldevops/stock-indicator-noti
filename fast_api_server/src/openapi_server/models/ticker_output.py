...
class TickerOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ticker", "tickerId", "name", "description", "createdAt", "modifiedAt"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TickerOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TickerOutput from a dict"""
        if obj is None:
            return None
