...
class CalculateIndicatorPost200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["result", "indicatorName", "indicatorCode", "createdAt", "modifiedAt"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CalculateIndicatorPost200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CalculateIndicatorPost200Response from a dict"""
        if obj is None:
            return None
